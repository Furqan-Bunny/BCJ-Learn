...
import { managers, teachers } from "@/data/users";
import { modules } from "@/data/modules";
import type { AttemptStatus, QuestionPool } from "@/types";
...
export default function TeacherResults() {
  // Demo: logged in as Nancy (owns Module 1)
  const me = teachers[0];
  ...
  const rows: AttemptRow[] = React.useMemo(
    () =>
      attempts
        .filter((a) => myModuleSlugs.has(a.moduleSlug))
