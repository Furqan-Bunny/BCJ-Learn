...
import {
  Search, Plus, MoreHorizontal, Mail, Edit3, Trash2, ShieldCheck, Sparkles,
} from "lucide-react";
  ...
  return (
    <>
                ...
                <TableCell>
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      ...
                      <DropdownMenuItem className="text-rose-600" onClick={() => toast(`${a.name} demoted`)}>
      ...
      <div className="grid lg:grid-cols-3 gap-4">
        {filtered.map((a) => {
          const myActivity = activity.filter((e) => e.actorId === a.id).slice(0, 5);
          return (
